...
function Message_Conditional_0_Conditional_9_Conditional_3_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const ctx_r0 = ɵɵnextContext(3);
    ɵɵproperty("styleClass", ctx_r0.cx("closeIcon"));
  }
}
function Message_Conditional_0_Conditional_9_Template(rf, ctx) {
  if (rf & 1) {
    ...
    ɵɵconditionalCreate(3, Message_Conditional_0_Conditional_9_Conditional_3_Template, 1, 1, "TimesIcon", 14);
    ɵɵelementEnd();
  }
  if (rf & 2) {
    const ctx_r0 = ɵɵnextContext(2);
...
var Message = class _Message extends BaseComponent {
  ...
  static ɵcmp = ɵɵdefineComponent({
    ...
    decls: 1,
    vars: 1,
    consts: [["escapeOut", ""], [1, "p-message", "p-component", 3, "class"], [1, "p-message", "p-component"], [3, "class"], [4, "ngIf", "ngIfElse"], [3, "ngClass"], ["pRipple", "", "type", "button", 3, "class"], [4, "ngTemplateOutlet"], [3, "ngClass", "innerHTML", 4, "ngIf"], [3, "ngClass", "innerHTML"], [3, "ngClass", 4, "ngIf"], [4, "ngTemplateOutlet", "ngTemplateOutletContext"], ["pRipple", "", "type", "button", 3, "click"], [3, "class", "ngClass"], [3, "styleClass"]],
