...
function Rating_ng_template_0_Conditional_3_Conditional_1_StarFillIcon_1_Template(rf, ctx) {
  if (rf & 1) {
    ɵɵelement(0, "StarFillIcon", 8);
  }
  if (rf & 2) {
    const ctx_r2 = ɵɵnextContext(4);
    ɵɵproperty("ngStyle", ctx_r2.iconOnStyle)("styleClass", ctx_r2.cx("onIcon"));
    ɵɵattribute("data-pc-section", "onIcon");
  }
}
function Rating_ng_template_0_Conditional_3_Conditional_1_Template(rf, ctx) {
  if (rf & 1) {
    ɵɵtemplate(0, Rating_ng_template_0_Conditional_3_Conditional_1_span_0_Template, 1, 5, "span", 5)(1, Rating_ng_template_0_Conditional_3_Conditional_1_StarFillIcon_1_Template, 1, 3, "StarFillIcon", 6);
  }
  if (rf & 2) {
...
function Rating_ng_template_0_Conditional_4_Conditional_1_StarIcon_1_Template(rf, ctx) {
  if (rf & 1) {
    ɵɵelement(0, "StarIcon", 8);
  }
  if (rf & 2) {
    const ctx_r2 = ɵɵnextContext(4);
    ɵɵproperty("ngStyle", ctx_r2.iconOffStyle)("styleClass", ctx_r2.cx("offIcon"));
    ɵɵattribute("data-pc-section", "offIcon");
  }
}
function Rating_ng_template_0_Conditional_4_Conditional_1_Template(rf, ctx) {
  if (rf & 1) {
    ɵɵtemplate(0, Rating_ng_template_0_Conditional_4_Conditional_1_span_0_Template, 1, 5, "span", 5)(1, Rating_ng_template_0_Conditional_4_Conditional_1_StarIcon_1_Template, 1, 3, "StarIcon", 6);
  }
  if (rf & 2) {
    const ctx_r2 = ɵɵnextContext(3);
...
var theme = ar`
    ...
    p-rating.ng-invalid.ng-dirty > .p-rating > .p-rating-icon {
        stroke: ${P("rating.invalid.icon.color")};
    }
`;
var classes = {
  root: ({
...
var Rating = class _Rating extends BaseEditableHolder {
  ...
  static ɵcmp = ɵɵdefineComponent({
    ...
    decls: 1,
    vars: 1,
    consts: [["ngFor", "", 3, "ngForOf"], [3, "click"], [1, "p-hidden-accessible"], ["type", "radio", 3, "focus", "blur", "change", "value", "checked", "pAutoFocus"], [4, "ngTemplateOutlet", "ngTemplateOutletContext"], [3, "class", "ngStyle", "ngClass", 4, "ngIf"], [3, "ngStyle", "styleClass", 4, "ngIf"], [3, "ngStyle", "ngClass"], [3, "ngStyle", "styleClass"]],
